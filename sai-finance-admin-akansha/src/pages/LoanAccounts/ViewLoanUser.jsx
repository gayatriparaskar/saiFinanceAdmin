...
function ViewLoanUser() {
  ...
  //   const startDate = dayjs(userdata?.active_loan_id?.created_on).format(
  //     "D MMM, YYYY"
  //   );
  ...
  //   doc.text(title, (pageWidth - titleWidth) / 2, 20); // Centered horizontally
  ...
  //   y = 30;
  //   const rightX = 120;
  //   doc.text(`End Date: ${endDate}`, rightX, y);
  //   y += 7;
  //   doc.text(`Total Due: Rs. ${due}`, rightX, y);
  //   y += 7;
  //   doc.text(`Total Paid: Rs. ${totalPay}`, rightX, y);
  ...
  //     { header: "Penalty (Rs.)", dataKey: "penalty" },
  //     { header: "Collected By", dataKey: "collectedBy" },
  //   ];

  //   const tableRows = Dailydata.map((item) => ({
  //     date: dayjs(item?.created_on).format("D MMM, YYYY h:mm A"),
  //     desc: "EMI Payment",
  //     amount: item?.amount || 0,
  //     penalty: item?.total_penalty_amount || 0,
  //     collectedBy: item?.collected_officer_name || "-",
  //   }));
  ...
  //   doc.setFontSize(9);
  //   doc.text("This is a system-generated loan statement.", 14, pageHeight - 10);
