                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white p-6 rounded-lg shadow">
                      ...
                      <p className="text-gray-600 mb-4">View weekly collection reports</p>
                      <a href="/manager-dashboard/weekly-report" className="text-blue-600 hover:text-blue-800">
                        View Weekly Report →
                      </a>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow">
                      <h2 className="text-lg font-semibold mb-2">Daily Report</h2>
                      <p className="text-gray-600 mb-4">View daily collection reports</p>
                      <a href="/manager-dashboard/daily-report" className="text-blue-600 hover:text-blue-800">
                        View Daily Report →
                      </a>
                    </div>
                  </div>
