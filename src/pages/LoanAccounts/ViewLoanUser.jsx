...
function ViewLoanUser() {
  ...
  const generatePDF = (customStartDate = null, customEndDate = null) => {
    ...
    doc.text(`Account Number : ${userdata.active_loan_id.account_number}`)
  ...
  return (
    <div className="lg:py-16 lg:pt-10 py-8 pt-2 px-6 bg-primaryBg">
                  ...
                  <div className="mt-6 max-w-md">
                              ...
                              {userdata?.officer_id && (
                                <p className="mt-2 text-sm text-green-600">
                                  Assigned Officer:{" "}
                                  <b>
                                    {userdata.officer_id.full_name ||
                                      userdata.officer_id.name}
                                  </b>
                                </p>
                              )}
                            </div>
