  ...
  return (
    <div className="m-6 py-8">
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-4 sm:p-6">
        ...
        <h4 className="text-base sm:text-lg font-bold mt-4 sm:mt-6">{t("Loan Details")}</h4>
           ...
           <div>
             ...
             <input
               className="mt-1 block w-full sm:w-2/3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm sm:text-base py-2 px-3"
               name="loan_amount"
