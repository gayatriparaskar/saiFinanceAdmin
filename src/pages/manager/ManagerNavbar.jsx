...
const ManagerNavbar = () => {
  ...
  const getCurrentPageName = () => {
    ...
    if (path.includes('/manager-dashboard/expenses')) return t('Expense');
  ...
  console.log('Manager Navbar - Navigation Items:', navigationItems);
  console.log('Manager Navbar - Expenses translation:', t("Expenses"));
  console.log('Manager Navbar - All translations test:', {
    Home: t("Home"),
    "Loan Account": t("Loan Account"),
    "Overdue Loans": t("Overdue Loans"),
    "Saving Account": t("Saving Account"),
    "Officer Controls": t("Officer Controls"),
    "Expenses": t("Expenses"),
    "Reports": t("Reports")
  });
  ...
  return (
    <motion.nav 
      ...
      initial="hidden"
      animate="visible"
      className="w-full flex items-center px-2 sm:px-4 py-0 shadow-lg fixed top-0 left-0 right-0 z-[99999] bg-white/95 backdrop-blur-md border-b-2 border-primary/10 h-16 sm:h-20"
    >
      {/* Logo with animation */}
      <motion.div 
        whileHover={{ scale: 1.05 }}
        transition={{ type: "spring", stiffness: 400, damping: 10 }}
        className="text-xl font-bold text-bggr w-10 sm:w-12 flex items-center flex-shrink-0"
      >
        <img src={Logo} alt="Sai Finance" className="w-full" />
      </motion.div>

      {/* Desktop Menu Items */}
      <ul className="hidden lg:flex items-center space-x-1 xl:space-x-2 font-semibold flex-1 justify-center mx-4">
